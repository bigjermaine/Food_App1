package com.example.food_app1.Presentation.Views.Search
...
import com.example.food_app1.Presentation.Components.SearchMealRow
...
fun SearchMealsScreen(
    ...
    Column(
        ...
        when {
            query.isNotBlank() && meals.isEmpty() -> {
                EmptySearchState()
            }
            meals.isNotEmpty() -> {
                LazyColumn {
